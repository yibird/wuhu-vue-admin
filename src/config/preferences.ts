...
export const tabThemeOptions = [
  {
    label: '块',
    value: TabsTheme.Block,
  },
  {
    label: '卡片',
    value: 'card',
...
export const loadingAnimationOptions = [
  {
    label: '跳动',
    value: LoadingAnimation.Beat,
  },
  {
    label: '轨道旋转',
    value: LoadingAnimation.Spinner,
  },
  {
    label: '脉冲扩散',
    value: LoadingAnimation.Pulse,
  },
  {
    label: '柱状跳动',
    value: LoadingAnimation.Bars,
  },
  {
    label: '圆环旋转',
    value: LoadingAnimation.Ring,
  },
]
export const pageAnimationOptions = [
  {
    label: '从左滑动',
    value: PageAnimation.SlideLeft,
  },
  {
    label: '从右滑动',
    value: PageAnimation.SlideRight,
  },
  {
    label: '从上滑动',
    value: PageAnimation.SlideUp,
  },
  {
    label: '从下滑动',
    value: PageAnimation.SlideDown,
  },
  {
    label: '淡入淡出',
  ...
  {
    label: '放大',
    value: PageAnimation.FadeScale,
  },
  {
    label: '横向反转',
    value: PageAnimation.FlipX,
  },
  {
    label: '竖向反转',
    value: PageAnimation.FlipY,
  },
] as const

export const pageAnimationModeOptions = [
  {
    label: '默认',
    value: PageAnimationMode.DEFAULT,
  },
  {
    label: '先出后进',
    value: PageAnimationMode.OUT_INT,
  },
  {
    label: '先进后出',
    value: PageAnimationMode.IN_OUT,
  },
] as const
...
export type PageAnimationMode =
  (typeof pageAnimationModeOptions)[number]['value']

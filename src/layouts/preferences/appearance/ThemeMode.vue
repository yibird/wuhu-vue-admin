  ...
  <div>
    ...
    <div class="grid grid-cols-3 gap-10">
      ...
      >
        <span
          :class="[
            'relative box-border block h-80 w-full overflow-hidden rounded-7 border-2 border-solid bg-container shadow-[0_4px_12px_rgb(var(--w-shadow-color-1))] transition-[transform,box-shadow] duration-motion-base ease-motion-enter group-hover:(-translate-y-1 shadow-[0_8px_20px_rgb(var(--w-shadow-color-1))]) group-focus-visible:shadow-[0_0_0_2px_rgb(var(--w-color-primary)_/_24%)] group-active:translate-y-0 motion-reduce:(transform-none transition-none)',

    ...
    <div class="grid h-[70vh] min-h-0 grid-rows-[auto_minmax(0,1fr)_auto]">
      ...
      >
        ...
        <div class="flex shrink-0 items-center gap-8">
          <button
            type="button"
            class="h-34 inline-flex cursor-pointer items-center justify-center gap-6 rounded-8 border-1 border-color-secondary border-solid bg-main px-12 text-13px text-regular transition-colors hover:border-primary hover:text-primary"
            @click="$emit('format')"
          >
          ...
          <button
            type="button"
            class="h-34 inline-flex cursor-pointer items-center justify-center gap-6 rounded-8 border-1 border-primary border-solid bg-primary px-12 text-13px text-white transition-colors hover:bg-primary/90"
            @click="$emit('apply')"
          >

...
import type { FilePreviewSource } from '@/components/filePreview'
import type { JsonValue } from '@/components/jsonView'
    ...
    <Scrollbar class="h-full" content-class="min-h-full p-16 md:p-20">
      ...
      >
        ...
        >
          ...
          <a-tag color="blue">src/components/filePreview</a-tag>
        </header>

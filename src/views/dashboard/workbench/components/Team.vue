    ...
    >
      ...
      <div class="p-12">
        <div
          v-for="item in items"
          :key="item.id"
          class="group rounded-8 p-10 transition-[background-color,box-shadow,transform] duration-200 hover:(-translate-y-1 bg-hover shadow-all-sm)"
        >
